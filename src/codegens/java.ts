...
export default class Java extends CodeGen {
  ...
  protected handleBoolean(s: Schema): TypeIntermediateRepresentation {
    return { documentationComment: this.buildDocs(s), typing: "boolean" };
  }
  ...
  protected handleNumber(s: Schema): TypeIntermediateRepresentation {
    return { documentationComment: this.buildDocs(s), typing: "double" };
  }

  protected handleInteger(s: Schema): TypeIntermediateRepresentation {
    return { documentationComment: this.buildDocs(s), typing: "int" };
  }
